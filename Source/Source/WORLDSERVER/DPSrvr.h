...
private:
	...
	void	OnRandomOptionRetry(CAr & ar, DPID dpidCache, DPID dpidUser, LPBYTE, u_long);
#endif
	...
	void	OnSortInventory(CAr & ar, DPID dpidCache, DPID dpidUser, LPBYTE lpBuf, u_long uBufSize);
#endif
