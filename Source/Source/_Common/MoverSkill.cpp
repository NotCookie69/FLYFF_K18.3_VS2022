...
int	CMover::DoUseItemSystem( ItemProp *pItemProp, CItemElem* pItemElem, int nPart )
{
	...
	case II_CHR_SYS_SCR_SHOUTFULL001:
		...
		break;
#ifdef __SYS_SCR_PARTYSPEEDLEVELUP
	...
	{ 
		...
		if(pParty && pParty->IsLeader( ((CUser*)this)->m_idPlayer ) ) 
			pParty->SetPartyLevel(((CUser*)this),40,pParty->GetPoint()+400,pParty->GetExp()); 
		else 
		{ 
			((CUser*)this)->AddText("This scroll can only be used by the party leader."); 
			nResult=2; 
		} 
	}
	break;
	...
	case II_CHR_SYS_SCR_ACTIVITION:
		...
		break;
#ifdef __SYS_SCR_NEWACTIVITION
	case II_CHR_SYS_SCR_NEWACTIVITION:
	{
		if (!(IsSMMode(SM_NEWACTPOINT)))
			SetSMMode(SM_NEWACTPOINT, pItemProp->dwCircleTime);
		else
			nResult = 2;
	}
	break;
...
BOOL CMover::IsDoUseBuff( ItemProp* pItemProp )
{
	...
	else if( HasBuff( BUFF_ITEM, (WORD)( pItemProp->dwID ) ) )
	{
		...
		|| pItemProp->dwID == II_GEN_TOO_COL_SILVERBATTERY_P
		|| pItemProp->dwID == II_GEN_TOO_COL_GOLDBATTERY_P
		|| pItemProp->dwID == II_GEN_TOO_COL_BATTERY001_P
#endif
		)
	{
...
#define II_SYS_SYS_SCR_PARTYSKILLUP01_01 20297
	...
	else if( pItemProp->dwID == II_SYS_SYS_SCR_PARTYPOINTFREE01
		|| pItemProp->dwID == II_SYS_SYS_SCR_PARTYPOINTFREE02
		|| pItemProp->dwID == II_SYS_SYS_SCR_PARTYPOINTFREE03
		)
	{
		if( HasBuff( BUFF_ITEM2, II_SYS_SYS_SCR_PARTYPOINTFREE01 )
			|| HasBuff( BUFF_ITEM2, II_SYS_SYS_SCR_PARTYPOINTFREE02 )
			|| HasBuff( BUFF_ITEM2, II_SYS_SYS_SCR_PARTYPOINTFREE03 )
			)
			nResult = 1;
	}
#endif
	...
	else if (pItemProp->dwID == II_SYS_SYS_ARMOREFFECTCHANGE_GOLD_7DAY
		|| pItemProp->dwID == II_SYS_SYS_ARMOREFFECTCHANGE_GOLD_15DAY
		|| pItemProp->dwID == II_SYS_SYS_ARMOREFFECTCHANGE_RED_7DAY
		|| pItemProp->dwID == II_SYS_SYS_ARMOREFFECTCHANGE_RED_15DAY
		|| pItemProp->dwID == II_SYS_SYS_ARMOREFFECTCHANGE_BLACK_7DAY
		|| pItemProp->dwID == II_SYS_SYS_ARMOREFFECTCHANGE_BLACK_15DAY
		|| pItemProp->dwID == II_SYS_SYS_ARMOREFFECTCHANGE_GREEN_7DAY
		|| pItemProp->dwID == II_SYS_SYS_ARMOREFFECTCHANGE_GREEN_15DAY
		|| pItemProp->dwID == II_SYS_SYS_ARMOREFFECTCHANGE_PUPPLE_7DAY
		|| pItemProp->dwID == II_SYS_SYS_ARMOREFFECTCHANGE_PUPPLE_15DAY
		|| pItemProp->dwID == II_SYS_SYS_ARMOREFFECTCHANGE_WHITE_7DAY
		|| pItemProp->dwID == II_SYS_SYS_ARMOREFFECTCHANGE_WHITE_15DAY)
	{
		if (HasBuff(BUFF_ITEM2, II_SYS_SYS_ARMOREFFECTCHANGE_GOLD_7DAY)
			|| HasBuff(BUFF_ITEM2, II_SYS_SYS_ARMOREFFECTCHANGE_GOLD_15DAY)
			|| HasBuff(BUFF_ITEM2, II_SYS_SYS_ARMOREFFECTCHANGE_RED_7DAY)
			|| HasBuff(BUFF_ITEM2, II_SYS_SYS_ARMOREFFECTCHANGE_RED_15DAY)
			|| HasBuff(BUFF_ITEM2, II_SYS_SYS_ARMOREFFECTCHANGE_BLACK_7DAY)
			|| HasBuff(BUFF_ITEM2, II_SYS_SYS_ARMOREFFECTCHANGE_BLACK_15DAY)
			|| HasBuff(BUFF_ITEM2, II_SYS_SYS_ARMOREFFECTCHANGE_GREEN_7DAY)
			|| HasBuff(BUFF_ITEM2, II_SYS_SYS_ARMOREFFECTCHANGE_GREEN_15DAY)
			|| HasBuff(BUFF_ITEM2, II_SYS_SYS_ARMOREFFECTCHANGE_PUPPLE_7DAY)
			|| HasBuff(BUFF_ITEM2, II_SYS_SYS_ARMOREFFECTCHANGE_PUPPLE_15DAY)
			|| HasBuff(BUFF_ITEM2, II_SYS_SYS_ARMOREFFECTCHANGE_WHITE_7DAY)
			|| HasBuff(BUFF_ITEM2, II_SYS_SYS_ARMOREFFECTCHANGE_WHITE_15DAY))
			nResult = 1;
	}
#endif
