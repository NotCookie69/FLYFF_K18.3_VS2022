...
#define PACKETTYPE_MODEL_CHANGE						(DWORD)0xAA000006
#define PACKETTYPE_OPENBOX							(DWORD)0xAA000007
#define PACKETTYPE_RANDOMOPTIONRETRY				(DWORD)0xAA000008
#define PACKETTYPE_LOOKCHANGE						(DWORD)0xAA000009
#define PACKETTYPE_SORT_INVENTORY					(DWORD)0xAA000010
#define PACKETTYPE_OPENCOUPON						(DWORD)0xAA000011
#define PACKETTYPE_EXCHANGECOUPON					(DWORD)0xAA000012
...
#define	SNAPSHOTTYPE_LOOKCHANGE						(WORD)0x8912
#define	SNAPSHOTTYPE_GETCOUPON						(WORD)0x8913
