...
#ifdef __SPEEDY_NEUZ
	if (m_bLogin)
		OnChildNotify(WNM_CLICKED, WIDC_NEXT, 0);
	else
		OnChildNotify(WNM_CLICKED, WIDC_BACK, 0);
#endif
}
	...
	for( int i = 0; i < MAX_CHARACTER_LIST; i++ )
	{
		...
		if( g_Neuz.m_apPlayer[i] != NULL )
		{
			...
			if( m_nSelectCharacter == i )
			{
                ...
                switch( i )
                {
                case 0:        pWndStaticChar[1]->m_dwColor = 0xFF0000FF,    pWndStaticChar[2]->m_dwColor = 0xFF666666,    pWndStaticChar[3]->m_dwColor = 0xFF666666; break;
                case 1:        pWndStaticChar[1]->m_dwColor = 0xFF666666,    pWndStaticChar[2]->m_dwColor = 0xFF0000FF,    pWndStaticChar[3]->m_dwColor = 0xFF666666; break;
                case 2:        pWndStaticChar[1]->m_dwColor = 0xFF666666,    pWndStaticChar[2]->m_dwColor = 0xFF666666,    pWndStaticChar[3]->m_dwColor = 0xFF0000FF; break;
                }
#else //__LECTURE_V17
